...
# Fonction permettant de mettre a jour la date d'un trimestre de la BDD
def update_one(id_trimestre, update: dict):
    results = collection.update_one({"idtrimestre": id_trimestre}, {"$set": update})
    return results
